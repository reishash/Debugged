package Assets.Scripts; public class Script { public static final String[] storyTexts = { "<html><b span style=color:#ed4337;>SYSTEM BOOT.</b></html>",
        ...
        "", //6 Reflection
        "<html><b span style=color:#ed4337;>DEADLOCK.</b></html>",
        "<html><i>Black screen.<html><i>",
        "<html><i>The hum of the laptop is louder now, like static on a broken radio.</i></html>",
        "<html><i>The glitch appears, more intense than before, distorting the edges of the screen like a crack in glass.</i></html>",
        "<html><i>Elara watches, her breath shallow. She knows this glitch is different.</i></html>",
        "<html><i>She reaches out, but this time, her hand trembles.</i></html>",
        "<html><i>The moment she touches the keys, she’s pulled into a dimly lit room.</i></html>",
        "<html><i>It’s familiar yet strange; her own bedroom, but somehow not.</i></html>",
        "<html><i>The walls are cracked, the furniture is askew, and the mirror on the wall reflects her image, but it’s distorted.</i></html>",
        "<html><i>The reflection doesn’t look like her.</i></html>",
        "<html><i>It looks like a version of herself she doesn’t recognize.</i></html>",
        "This... isn’t right.",
        "<html><i>She steps closer to the mirror, her reflection mirroring her every move, but the face staring back at her is cold, distant.</i></html>",
        "<html><i>The eyes are hollow, the expression unreadable.<html><i>",
        "<html><b span style=color:'red';>Is this really who you are?</span></html>",
        "<html><i>Elara flinches, her heart racing.</i></html>",
        "<html><i>The reflection’s voice is familiar, but it feels like a stranger’s.</i></html>",
        "<html><i>It feels like the doubts that have always lingered in the back of her mind, finally given form.</i></html>",
        "You’re not me.",
        "<html><b span style=color:'red';>Am I not? How can you be so sure?</i></html>",
        "<html><i>The reflection smiles, but it’s predatory, like a wolf baring its teeth.</i></html>",
        "<html><i>Elara’s chest tightens, and she backs away from the mirror, her breath coming faster.",
        "This isn’t real. It can’t be.",
        "<html><i>The reflection steps out of the mirror, its movements jerky, unnatural.<",
        "<html><i>It walks toward Elara, its eyes locked on hers, never blinking.</i></html>",
        "<html><b span style=color:'red';>You’ve spent your whole life trying to be something you’re not.</span></html>",
        "<html><b span style=color:'red';>Trying to be perfect. Trying to be enough.</span></html>",
        "<html><b span style=color:'red';>You're not enough.</span></html>",
        "<html><b span style=color:'red';>You’ll never be enough.</span></html>",
        "<html><i>The words hit like a slap, cold and sharp.</i></html>",
        "<html><i>Elara stumbles back, the room spinning.</i></html>",
        "<html><i>The reflection steps closer, its voice growing louder, more insistent.</i></html>",
        "<html><b span style=color:'red';>You failed your friends.</span></html>",
        "<html><b span style=color:'red';>You failed your dreams.</span></html>",
        "<html><b span style=color:'red';>You failed yourself.</span></html>",
        "<html><i>Elara’s heart races, her chest tight with panic.</i></html>",
        "<html><i>She turns away, trying to escape, but the reflection follows, its voice growing louder with every step.</i></html>",
        "<html><b span style=color:'red';>You don’t deserve happiness. You LOST that right.</span></html>",
        "<html><i>Elara falls to her knees, her hands over her ears, trying to block out the voice.</i></html>",
        "<html><i>But it’s inside her head, echoing in every corner of her mind.</i></html>",
        "<html><i>She looks up, her eyes wide with fear.</i></html>",
        "I do deserve happiness.",
        "<html><i>The reflection laughs, but it’s hollow, empty.</i></html>",
        "<html><i>It steps closer, its face inches from Elara’s.</i></html>",
        "<html><i>The coldness of its gaze sends a shiver down her spine.</i></html>",
        "<html><b span style=color:'red';>You didn’t believe that then. Why would you believe it now?</span></html>",
        "<html><i>Elara’s hands tremble as she reaches up to touch the reflection’s face, her fingers brushing against the cold surface.</i></html>",
        "<html><i>The reflection mirrors her every movement, its expression twisted in disdain.</i></html>",
        "I don’t have to be perfect.",
        "I don’t have to be what you want me to be.",
        "<html><i>The reflection’s smile fades, replaced by a look of confusion, then anger.</i></html>",
        "<html><i>The air around Elara grows heavy, the room warping, distorting.</i></html>",
        "<html><b span style=color:'red';>You can’t run from me. I am you.</span></html>",
        "<html><i>Elara stands up, her legs shaking, but her voice steady.</i></html>",
        "<html><i>She looks at the reflection. She looks at herself.</i></html>",
        "No. You’re not.",
        "You’re just nothing but a glitch.",
        "A glitch that I can fix.",
        "<html><i>The reflection falters, its form flickering like a broken image.</i></html>",
        "<html><i>Elara steps forward. She reaches out, touching the mirror once more.</i></html>",
        "<html><i>This time, the glass is warm.</i></html>",
        "<html><i>The reflection begins to crack, the distorted image shattering like glass falling to the floor.</i></html>",
        "I am enough. I deserve happiness.",
        "And I’m going to stop running from myself.",
        "<html><i>The mirror shatters completely, the pieces falling to the ground, leaving only darkness.</i></html>",
        "<html><i>For a moment, Elara stands in silence, her heart pounding.</i></html>",
        "<html><i>Then, she exhales, a sense of calm settling over her.</i></html>",
        "I have spent so long trying to be perfect.",
        "But maybe... maybe I don’t need to be perfect. I just need to be me.",
        "<html><i>Elara takes a deep breath, a smile tugging at the corners of her lips.</i></html>",
