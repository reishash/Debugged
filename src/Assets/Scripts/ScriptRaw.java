package Assets.Scripts; public class ScriptRaw { public static final String[] storyTexts = { "SYSTEM BOOT.",
        ...
        "The scene opens in a bright, bustling arcade. Laughter echoes, neon lights flash, and the sound of coins clinking fills the air.",
        ...
        "The group is smaller now; just Elara and one other friend. The others are gone, their absence a silent ache.",
        ...
        "I’m fine. Really.",
        "The scene fades, leaving Elara standing in the empty arcade. The claw machine is still there, but the lights are dim, the laughter gone.",
        ...
        "Elara’s gaze shifts to the claw machine. The reflection in the glass shows her current self, older and heavier with regret.",
        ...
        "You’re not me.",
        "Am I not? How can you be so sure?",
        "The reflection smiles, but it’s predatory, like a wolf baring its teeth.",
        ...
        "Trying to be perfect. Trying to be enough.",
        "You’re not enough.",
        ...
        "You don’t deserve happiness. You LOST that right.",
        "Elara falls to her knees, her hands over her ears, trying to block out the voice.",
        "But it’s inside her head, echoing in every corner of her mind.",
        ...
        "You didn't believe that then. Why would you believe it now?",
        ...
        "Elara stands up, her legs shaking, but her voice steady.",
        "She looks at the reflection. She looks at herself.",
        "No. You’re not.",
        "You're just nothing but a glitch.",
        "A glitch that I can fix.",
        "The reflection falters, its form flickering like a broken image.",
        "Elara steps forward. She reaches out, touching the mirror once more.",
        ...
        "I’ve spent so long trying to be perfect.",
        "But maybe... maybe I don’t need to be perfect. I just need to be me.",
        "Elara takes a deep breath, a smile tugging at the corners of her lips.",
